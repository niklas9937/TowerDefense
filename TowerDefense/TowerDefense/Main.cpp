...
int hi(int statusLevel1, int statusLevel2, int statusLevel3)
{
    ...
    SDL_Rect Message_rect1 = { 45,100,surfaceMessage1->w,surfaceMessage1->h }; //create a rect
    ...
    SDL_Rect Message_rect2 = { 85,100,surfaceMessage2->w,surfaceMessage2->h }; //create a rect
    ...
    SDL_Rect Message_rect3 = { 125,100,surfaceMessage3->w,surfaceMessage3->h }; //create a rect
