...
Defense::Defense(AffinityType type, Point coords, int p)
{
	...
	case AffinityType::small: Defense::posi = coords; Defense::price = 60; Defense::damage = 3; Defense::range = 40; Defense::beschreibung = "short range tower"; break;
		...
		case AffinityType::large: Defense::posi = coords; Defense::price = 150; Defense::damage = 6; Defense::range = 70; Defense::beschreibung = "long range tower"; break;
		case AffinityType::fire: Defense::posi = coords; Defense::price = 200; Defense::damage = 9; Defense::range = 70; Defense::beschreibung = "fire attribute"; break;
		...
		case AffinityType::toxic: Defense::posi = coords; Defense::price = 200; Defense::damage = 9; Defense::range = 70; Defense::beschreibung = "toxic"; break;
		case AffinityType::water: Defense::posi = coords; Defense::price = 200; Defense::damage = 9; Defense::range = 70; Defense::beschreibung = "water attribute"; break;
		case AffinityType::wind: Defense::posi = coords; Defense::price = 200; Defense::damage = 9; Defense::range = 70; Defense::beschreibung = "wind attribute"; break;
